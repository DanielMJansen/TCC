...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content">
        ...
        <div class="page-content">
            ...
            <p align="center">O metodo de pontuacao funciona conforme o tempo usado pelo jogador para achar a saída do labirinto, quanto menos tempo, maior a pontuacao.</p>
        </div>
    </main>